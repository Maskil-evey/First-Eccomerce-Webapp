...
vegetabaleItems: ShoppingItem[] = this.shoppingItems.filter(item => item.category === 'Vegetable');
...
spiceItems: ShoppingItem[] = this.shoppingItems.filter(item => item.category === 'Spice');
